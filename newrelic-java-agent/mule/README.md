...
> [!NOTE]
> Currently the fix variant will cause the instrumentation to hang after making a call, this is due to preexisting issues with the extension and is being actively worked on by Labs.
